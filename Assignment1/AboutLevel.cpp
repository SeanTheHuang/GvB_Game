...
void AboutLevel::Initialize()
{
	...
	CSprite* logo = new CSprite("Resources/Images/LogoImage.png", glm::vec2(1000, 120), glm::vec2(200, 200));
	m_sprites.push_back(logo);

	CTextui* testText = new CTextui(glm::vec3(100, 570, 0), glm::vec3(glm::vec3(0.7f, 0.1f, 0.8f)), 
		"In an alternate timeline, after the great Battle of Snake Racers 2025,", "Resources/Fonts/Arial.ttf");
	m_texts.push_back(testText);

	CTextui* testText2 = new CTextui(glm::vec3(100, 510, 0), glm::vec3(glm::vec3(0.7f, 0.1f, 0.8f)), 
		"Globs and Blobs have slammed everything out of existence."
		, "Resources/Fonts/Arial.ttf");
	m_texts.push_back(testText2);

	CTextui* testText3 = new CTextui(glm::vec3(100, 450, 0), glm::vec3(glm::vec3(0.7f, 0.1f, 0.8f)), 
		"There is nothing else to slam, therefore they resort to slamming each other."
		, "Resources/Fonts/Arial.ttf");
	m_texts.push_back(testText3);

	CTextui* testText4 = new CTextui(glm::vec3(100, 390, 0), glm::vec3(glm::vec3(0.7f, 0.1f, 0.8f)), 
		"Some Globs do not wish to slam, but are forced to by their instinct to survive."
		, "Resources/Fonts/Arial.ttf");
	m_texts.push_back(testText4);

	CTextui* testText5 = new CTextui(glm::vec3(100, 330, 0), glm::vec3(glm::vec3(0.7f, 0.1f, 0.8f)),
