...
//	shaderHelper.CompileAndLinkShaders("Assets/Shaders/text.vs", "Assets/Shaders/text.fs", program);
//
...
//		//CLog::Write("ERROR::FREETYPE: Could not init FreeType Library");
//
//	// Load font as face
//	FT_Face face;
//	if (FT_New_Face(ft, font.c_str(), 0, &face))
//		//CLog::Write("ERROR::FREETYPE: Failed to load font");
//
...
//			//CLog::Write("ERROR::FREETYTPE: Failed to load Glyph");
//			continue;
//		}
//
//		// Generate texture
...
//}
//
//void TextLabel::SetHidden(bool _bHidden)
//{
//	m_bHidden = _bHidden;
//}
//
//bool TextLabel::GetHidden()
//{
//	return m_bHidden;
//}
