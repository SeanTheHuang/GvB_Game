...
void GameLevel3::Initialize(std::vector<Player> _players)
{
	GLuint cubeShaders;
	...
	// =================Players=====================
	m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(2.25f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this, 1));
	m_vecPlayers.at(0)->SetArrow(CArrow::CreateArrow(m_vecShaders.at(1), glm::vec3(2.25f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this));
	m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(		0.75f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this, 2));
	m_vecPlayers.at(1)->SetArrow(CArrow::CreateArrow(m_vecShaders.at(1), glm::vec3(	0.75f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this));
	m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(		-0.75f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this, 3));
	m_vecPlayers.at(2)->SetArrow(CArrow::CreateArrow(m_vecShaders.at(1), glm::vec3(	-0.75f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this));
	m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(		-2.25f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this, 4));
	m_vecPlayers.at(3)->SetArrow(CArrow::CreateArrow(m_vecShaders.at(1), glm::vec3(	-2.25f * platformWidth,	3.0f * pillarHeight + platformHeight, -5.0f), *this));
