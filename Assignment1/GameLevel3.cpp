...
void GameLevel3::Initialize(std::vector<Player> _players)
{
	...
	case 4:
	{
		m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(-0.75f * platformWidth, 3.0f * pillarHeight + platformHeight, -5.0f), *this, 4));
	...
	case 2:
	{
		m_vecPlayers.push_back(CPlayer::CreatePlayer(m_vecShaders.at(2), glm::vec3(-2.25f * platformWidth, 3.0f * pillarHeight + platformHeight, -5.0f), *this, 2));
