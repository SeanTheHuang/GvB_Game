...
CGround::CGround(GLuint _shaders, glm::vec3 _position, Level& level) :
	m_iIndices(0),
	m_shaders(_shaders),
	pTexture(nullptr),
...
void CGround::SetPhysics()
{
	...
	dynamicBox.SetAsBox(31.5f / Level::s_kPixelsPerMeter, 1.0f / Level::s_kPixelsPerMeter);	// The platforms dimentions are 7 by 2 units
...
void CGround::DrawObject()
{
	glUseProgram(m_shaders);
	glm::mat4 Scale = glm::scale(glm::mat4(1.0f), glm::vec3(9.0f, 1.0f, 1.0f));
...
CGround * CGround::CreateGround(GLuint _shaders, glm::vec3 _position, Level& level)
{
	CGround* ground = new CGround(_shaders, _position, level);
	return ground;
}

void CGround::getUniformLocation()
{
